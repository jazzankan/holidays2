...
(function($, window, undefined) {
	...
	var uniqueId = 0; // used for unique ID generation within multiple plugin instance
	...
	$.widget('comiseo.daterangepicker', {
		...
		options: {
			...
			initialText: 'Välj semesterperiod', // placeholder text - shown when nothing is selected
			icon: 'ui-icon-triangle-1-s',
			applyButtonText: 'Spara', // use '' to get rid of the button
			clearButtonText: 'Ta bort', // use '' to get rid of the button
			cancelButtonText: '', // use '' to get rid of the button
...
//				showCurrentAtPos: 1 // bug; use maxDate instead
				maxDate: 120 // the maximum selectable date is today (also current month is displayed on the last position)
			}
		},
